...
def build_video_texts_template(song_name: str, artist_name: str, language: str) -> str:
    ...
    templates = {
        "en": (
            ...
            "\n"
            "Pin comment:\n"
            "🎤 More vocals only & karaoke tracks coming soon!\n"
            "\n"
            "Which song should I upload next? 🎶\n"
        ),
        "tr": (
            "Title:\n"
            ...
            "\n"
            "🎧 En iyi dinleme deneyimi için kulaklık kullanın.\n"
            "\n"
            ...
            "\n"
            "Pin comment:\n"
            "🎤 Yakında daha fazla sadece vokal & karaoke parçası geliyor!\n"
            "\n"
            "Bir sonraki hangi şarkıyı yüklememi istersiniz? 🎶\n"
        ),
    }
